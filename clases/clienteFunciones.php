...
function registrarCliente(array $datos, $con){
        $sql = $con->prepare("INSERT INTO clientes (nombres, apellidos, email, telefono, direccion, dni, estatus, fecha_alta) VALUES
        (?,?,?,?,?,?, 1, now())");
...
function emailExiste($email, $con){
    ...
    function validaToken($id, $token, $con){
        ...
        if(activarUsuario($id, $con))            {
            $msg = "Cuenta activada. Ya puede iniciar sesion";
    }else{  
