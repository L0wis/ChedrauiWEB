...
INSERT INTO `backups` VALUES (1,'2024-05-13 15:50:50','ResBD-DM1305.sql','../respaldos/',NULL,'admin, backups, categorias, clientes, compra, compra_personal, compra_personal_productos, configuracion, detalle_compra, notificacion, notificacion_producto, personal, productos, proveedores, transaccion_prov, usuarios',NULL,'Respaldo prueba 1'),(2,'2024-05-13 15:56:30','ResBD-DM1305.sql','../respaldos/',NULL,'admin, backups, categorias, clientes, compra, compra_personal, compra_personal_productos, configuracion, detalle_compra, notificacion, notificacion_producto, personal, productos, proveedores, transaccion_prov, usuarios',NULL,'PRUEBA 2'),(3,'2024-05-13 16:02:59','ResBD-DM1305.sql','../respaldos/',NULL,'admin, backups, categorias, clientes, compra, compra_personal, compra_personal_productos, configuracion, detalle_compra, notificacion, notificacion_producto, personal, productos, proveedores, transaccion_prov, usuarios',NULL,'PRUEBA 3'),(4,'2024-05-13 16:15:39','ResBD-DM1305.sql','../respaldos/',NULL,'admin, backups, categorias, clientes, compra, compra_personal, compra_personal_productos, configuracion, detalle_compra, notificacion, notificacion_producto, personal, productos, proveedores, transaccion_prov, usuarios',NULL,'PRUEBA 3'),(5,'2024-05-13 16:17:38','ResBD-DM1305.sql','../respaldos/',NULL,'admin, backups, categorias, clientes, compra, compra_personal, compra_personal_productos, configuracion, detalle_compra, notificacion, notificacion_producto, personal, productos, proveedores, transaccion_prov, usuarios',NULL,'PRUEBA 3'),(6,'2024-05-13 16:42:45','ResBD-DM1305.sql','../respaldos/',NULL,'admin, backups, categorias, clientes, compra, compra_personal, compra_personal_productos, configuracion, detalle_compra, notificacion, notificacion_producto, personal, productos, proveedores, transaccion_prov, usuarios',NULL,'PRUEBA 4'),(7,'2024-05-13 17:14:13','chedraui_20240513_170545.sql','../respaldos/',NULL,'todas las tablas de la base de datos',NULL,'PRueba 5'),(8,'2024-05-13 17:22:06','chedraui_20240513_172201.sql','../respaldos/',NULL,'todas las tablas de la base de datos',NULL,'PRueba 6'),(9,'2024-05-13 17:25:02','chedraui_20240513_172457.sql','../respaldos/',NULL,'todas las tablas de la base de datos',NULL,'PRueba 7'),(10,'2024-05-13 17:31:06','chedraui_20240513_173101.sql','../respaldos/',NULL,'todas las tablas de la base de datos',NULL,'PRueba 8'),(11,'2024-05-13 17:32:27','chedraui_20240513_173224.sql','../respaldos/',NULL,'todas las tablas de la base de datos',NULL,'PRueba 9'),(12,'2024-05-13 17:33:23','chedraui_20240513_173319.sql','../respaldos/',NULL,'todas las tablas de la base de datos',NULL,'PRueba 11'),(13,'2024-05-13 17:33:37','chedraui_20240513_173333.sql','../respaldos/',NULL,'todas las tablas de la base de datos',NULL,'PRueba 12\r\n'),(14,'2024-05-13 17:35:21','chedraui_20240513_173517.sql','../respaldos/',NULL,'todas las tablas de la base de datos',NULL,'PRueba 13'),(15,'2024-05-13 17:36:33','chedraui_20240513_173629.sql','../respaldos/',NULL,'todas las tablas de la base de datos',NULL,'PRueba 14'),(16,'2024-05-13 17:44:06','chedraui_20240513_174352.sql','../respaldos/',NULL,'asdfghjklñ',NULL,'Prueba 15');
...
-- Dump completed on 2024-05-13 11:44:07
