...
<main>
    <div class="container-fluid px-4">
        ...
        <a href="descargar_reporte.php" class="btn btn-success"><i class="bi bi-filetype-pdf"></i> Reporte productos PDF</a>
        <a href="descargar_reporte_excel.php" class="btn btn-primary"><i class="bi bi-file-spreadsheet-fill"></i> Reporte de Productos Excel</a>
        <a href="productos_desactivados.php" class="btn btn-danger"><i class="bi bi-cart-x-fill"></i> Productos Desactivados</a>

                <!-- Nuevo botón "Crear Notificación" con color diferente -->
                <a href="notificacion.php" class="btn btn-warning ms-auto"><i class="bi bi-bell"></i> Notificación</a>
